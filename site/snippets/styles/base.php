 ...
 * ============================= */
  ...
  *::after {
  ...
  a {
    ...
    -webkit-text-stroke: var(--font-stroke-smcp);
  }
  ...
  .allcaps {
    letter-spacing: calc(var(--tracking-base) + 0.01em);
  }
 ...
 * ============================= */
  ...
  .site-name .allcaps {
    letter-spacing: calc(var(--tracking-nav) + 0.01em);
  }
  ...
  .site-name::after {
    content: '\a0\2012\2012\2012';
  }

  .pages-navigation li::after {
    content: '\a0\a0\a0\2012\2012\2012';
  }
  ...
  .pages-navigation li:hover::after,
  .site-name.current::after,
  .pages-navigation li.current::after {
    opacity: 1;
  }
 ...
 * ============================= */
  ...
  .texts .text-container {
    ...
    line-height: 1.75;
    -webkit-text-stroke: var(--font-stroke-texts);
  }
